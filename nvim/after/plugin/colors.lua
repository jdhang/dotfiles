...
vim.keymap.set('n', '<leader>cm', '<cmd>colorscheme catppuccin-mocha<CR>',
  { desc = 'set [c]olorscheme: catppuccin-[m]ocha' })
vim.keymap.set('n', '<leader>cr', '<cmd>colorscheme rose-pine<CR>',
  { desc = 'set [c]olorscheme: [r]ose-pine' })
-- vim.keymap.set('n', '<leader>cr', '<cmd>colorscheme rose-pine-moon<CR>',
...
vim.keymap.set('n', '<leader>cc', '<cmd>colorscheme carbonfox<CR>',
  { desc = 'set [c]olorscheme: [c]arbonfox' })
