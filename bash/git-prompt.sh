...
function spaceship_git_branch() {
  ...
  printf "$SPACESHIP_GIT_BRANCH_COLOR$SPACESHIP_GIT_SYMBOL$(git_current_branch)$SPACESHIP_GIT_BRANCH_SUFFIX"
}
...
function node_prompt() {
  ...
  # _prompt_section \
    ...
    # "$SPACESHIP_NODE_SUFFIX"
  printf "$RESETBOLD$SPACESHIP_NODE_PREFIX$SPACESHIP_NODE_COLOR$SPACESHIP_NODE_SYMBOL$node_version$SPACESHIP_NODE_SUFFIX$RESET"
}
